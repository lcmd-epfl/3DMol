...
parser.add_argument('--old', choices=['ins8adml', 'q3r6sjjn', 'umtzjghf', 'p3mh45nv'], help='use parameters from a previous run')
...
sweep_config = { 'method': 'grid', 'metric': metric, 'name': f'{target_column}_{script_args.arch}' }

old_values = {
'ins8adml':    [64,  0     ,  0.0005 , 48 , 32 , 5  ],
'q3r6sjjn':    [32,  0     ,  0.0005 , 48 , 48 , 10 ],
'umtzjghf':    [48,  0     ,  0.0005 , 48 , 48 , 5  ],
'p3mh45nv':    [32,  0     ,  0.001  , 48 , 32 , 10 ],
}
