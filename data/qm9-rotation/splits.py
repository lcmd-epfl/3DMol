...
idx.train[0], idx.test[0], idx.val[0] = np.split(indices, [tr_size, tr_size+te_size])

possible_test = np.random.permutation(np.setdiff1d(indices, idx.test[0]))
idx.test[1:] = np.array_split(possible_test, nsplits-1)
